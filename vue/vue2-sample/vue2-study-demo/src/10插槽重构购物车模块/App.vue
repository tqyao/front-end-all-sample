...
<script>
import Header from "@/10插槽重构购物车模块/components/Header/Header"
import Footer from "@/10插槽重构购物车模块/components/Footer/Footer"
import Goods from "@/10插槽重构购物车模块/components/Goods/Goods"
import Counter from "@/10插槽重构购物车模块/components/Counter/Counter.vue"
